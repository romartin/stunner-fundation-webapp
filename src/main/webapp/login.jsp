...
<head>
  <title>Login - Stunner Fundation WebApp</title>
  <link rel="stylesheet" href="org.roger600.stunner.fundation.StunnerFundationWebapp/css/patternfly.min.css">
  <link rel="stylesheet" href="org.roger600.stunner.fundation.StunnerFundationWebapp/css/patternfly-additions.min.css">
</head>

<body>
<span id="badge">
  <img src="org.roger600.stunner.fundation.StunnerFundationWebapp/images/uf_logo.png" alt="UberFire Logo" title="Powered By Uberfire"/>
</span>
<div class="container">
  <div class="row">
    <div class="col-sm-12">
      <div id="brand">
        <img src="org.roger600.stunner.fundation.StunnerFundationWebapp/images/uf.png" alt="Uberfire UI Framework">
      </div>
    </div>
    ...
    <div class="col-sm-5 col-md-6 col-lg-7 details">
      <p><strong>Welcome to Stunner Fundation WebApp</strong></p>
    </div>
  </div>
</div>
